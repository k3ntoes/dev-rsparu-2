...
class AuthController extends Controller
{
	...
	public function login()
	{
		...
		if ($this->auth->check()) {
			$redirectURL = session('redirect_url') ?? site_url('/Main');
	...
	public function attemptLogin()
	{
		...
		$this->setTheCookies($this->auth->user()->jwtHash);
	...
	protected function setTheCookies($token): void
	{
		setcookie("x-token", $token);
	}

	protected function delTheCookies(): void
	{
		setcookie("x-token", "", time() - 3600);
	}
}
