...
<body>
    <div style="border:1px solid black; padding:10px; overflow: auto; height: 100%">
        <table width="100%">
            <tr>
                <td>
                    <img src="/assets/images/banyumas.png" style="width:4.5cm">
                </td>
