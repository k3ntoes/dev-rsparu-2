<div class="modal fade" id="pindahModal" tabindex="-1" role="dialog" aria-labelledby="pindahModal">
            ...
            <div class="modal-body">
                <form action="#" id="frmPindah">
                    ...
                    <div class="form-group">
                        ...
                        <select id="ktujuan-pindah" class="ktujuan form-control select2"></select>
                    </div>
                </form>
            </div>
