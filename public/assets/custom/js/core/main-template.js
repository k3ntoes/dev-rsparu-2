(function ($) {
    ...
    $(window).on("load", function () {
        ...
        $('.toUpper').on('blur', e => { Core.module.toUpper(e) })
        NProgress.done();
    ...
    Core.module = {
        ...
        menu: function () {
            let pn = window.location.pathname.replace('/', '')
            $('.menu li').removeClass('current')
            if (pn === "") $('#Beranda').addClass('current')
            $(`#${pn}`).addClass('current')
        ...
        toUpper: e => {
            ...
            let removeTick = upCase.replace("'", "`")
            removeTick = removeTick.replace('"', '`')
            e.target.value = removeTick
            return false
        }
    }
